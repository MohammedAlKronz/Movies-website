...
const MovieDetails = () => {
  ...
  // Git Movie by Details
  const getMovieDetails = async () => {
    const res = await axios.get(`https://api.themoviedb.org/3/movie/${param.id}?api_key=6e72d0482679c358b50e02f5ec671cff&language=ar`);
    setMovie(res.data);
  };
  ...
  return (
    <div>
      ...
      <Row className="justify-content-center">
        <Col md="10" xs="12" sm="12" className="mt-2 mb-3 d-flex justify-content-center">
          <Link to="/">
            <button
